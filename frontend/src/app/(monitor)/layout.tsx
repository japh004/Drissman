...
import { Loader2, LayoutDashboard, CalendarDays, Users, LogOut, Car } from "lucide-react";
            ...
            <header className="sticky top-0 z-30 bg-asphalt/80 backdrop-blur-lg border-b border-white/[0.06]">
                <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                    <Link href="/monitor" className="flex items-center gap-2">
                        <div className="bg-gradient-to-br from-signal to-amber-400 p-2 rounded-xl"><Car className="h-4 w-4 text-asphalt" /></div>
