            ...
            `}>
                ...
                <div className="p-6 flex items-center justify-between">
                    <Link href="/admin" className="flex items-center gap-3 group">
                        <div className="bg-gradient-to-br from-signal to-amber-400 p-2.5 rounded-xl">
                ...
                <div className="mx-4 mb-4 p-3 bg-white/5 rounded-xl border border-white/5">
                    <p className="text-xs text-mist/60 uppercase tracking-wider font-bold">Admin</p>
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                `}
                            >
                                <item.icon className={`h-4.5 w-4.5 ${isActive ? "text-signal" : "text-mist/60 group-hover:text-mist"}`} />
                                {item.name}
                                {isActive && <ChevronRight className="h-3.5 w-3.5 ml-auto text-signal/60" />}
                            </Link>
                        );
                    })}
                </nav>
